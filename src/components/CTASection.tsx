      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="relative z-10 glass-card p-12 md:p-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <button
              className="group bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold text-xl px-12 py-2 rounded-lg shadow-2xl hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 animate-pulse-glow"
              style={{ 
