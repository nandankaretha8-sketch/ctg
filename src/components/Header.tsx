...
import { Menu, X, BarChart3, LogIn, Rocket, LogOut, User, Shield, FileText, HelpCircle, Scale, Mail, Settings } from "lucide-react";
          ...
          <div className="flex items-center space-x-3">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link to="/register">
                  <button
                    className="text-sm px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-lg shadow-2xl hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 animate-pulse-glow"
                    style={{ 
