...
const PushNotificationSender: React.FC<PushNotificationSenderProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    console.log('🚀 [PUSH NOTIFICATION SENDER] Form submit triggered');
    e.preventDefault();
    
    console.log('🚀 [PUSH NOTIFICATION SENDER] Form data:', formData);
    
    if (!formData.title.trim() || !formData.message.trim()) {
      console.log('❌ [PUSH NOTIFICATION SENDER] Validation failed - missing title or message');
