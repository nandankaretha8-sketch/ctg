...
const MentorshipChatbox = () => {
  ...
  const fetchChatbox = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/mentorship-chatboxes/${planId}`, {
        headers: {
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/mentorship-chatboxes/${planId}/messages`, {
        method: 'POST',
        headers: {
